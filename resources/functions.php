...
<div class="col-sm-4 col-lg-4 col-md-4">
    <div class="thumbnail">
        <a href="item.php?id={$row['product_id']}"><img src="../resources/{$product_image}" style="width: 100%;
...
$product_image          = escape_string($_FILES['photo']['name']);
$image_temp_location    = escape_string($_FILES['photo']['tmp_name']);

move_uploaded_file($_FILES["photo"]["tmp_name"], UPLOAD_DIRECTORY . DS . $_FILES["photo"]["name"]);
